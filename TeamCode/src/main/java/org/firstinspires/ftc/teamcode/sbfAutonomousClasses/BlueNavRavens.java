...
@Disabled
@Autonomous(name="BlueNavRavens", group="Zombie")
/** The autonomous class that starts on the quarry side of the field and parks under the bridge next to the skybridge.
 *
 * @author Andrew, 8668 Should Be Fine!
 * @see SBF_Autonomous
 * */
public class BlueNavRavens extends SBF_Autonomous
{
    /** Locates the Blue Nav Ravens CSV file and sets the robot's starting position. */
